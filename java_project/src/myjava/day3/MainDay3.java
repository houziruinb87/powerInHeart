...
//       System.out.println(Arrays.toString(Day3.partition(array,0, array.length-1)));
       System.out.println(Arrays.toString(Day3.callByOutQuickSort(array,0,( array.length)-1)));
